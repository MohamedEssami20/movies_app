                ...
                builder: (context) {
                  return BlocProvider(
                    create: (context) => MoviesDetailsCubit(
                      detailsMoviesRepos: getIt<DetailsMoviesRepos>(),
                    ),
                    child: CustomTrailerMovie(
                      movieId: moviesDetailsEntity.movieId,
                      movieName: moviesDetailsEntity.movieTitle,
                      movieOverview: moviesDetailsEntity.movieOverview,
                    ),
                  );
                },
              );
